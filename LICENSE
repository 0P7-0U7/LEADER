LEADER LICENSE AND ATTRIBUTION:
This project (LEADER) utilizes ESP-NOW and the ESP-IDF framework, which are 
licensed under the Apache License 2.0 by Espressif Systems. The original 
permissions of those components are preserved. 

All unique code, logic, and protocol implementations in the LEADER library 
